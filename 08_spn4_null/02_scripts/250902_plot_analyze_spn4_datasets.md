...
- [Calculate Adjusted P-values using T Tests &
  ...
  - [Figure 3: Plot lineplots of select transcripts with just two
    genotypes](#figure-3-plot-lineplots-of-select-transcripts-with-just-two-genotypes)
- [Figure F3E: Calculate and plot the 4-cell difference
  values](#figure-f3e-calculate-and-plot-the-4-cell-difference-values)
- [Export supplemental data](#export-supplemental-data)
...
print a very different versions.
...
![](250902_plot_analyze_spn4_datasets_files/figure-gfm/savePlots1-1.png)<!-- -->

    ## quartz_off_screen 
    ##                 2

    ## [1] "/Users/erinnishimura/Library/CloudStorage/Dropbox/github/SPN4_maternal_mRNA/08_spn4_null"
...
![](250902_plot_analyze_spn4_datasets_files/figure-gfm/savePlots2-1.png)<!-- -->
...
![](250902_plot_analyze_spn4_datasets_files/figure-gfm/4cell_test-1.png)<!-- -->
...
![](250902_plot_analyze_spn4_datasets_files/figure-gfm/4cell_test-2.png)<!-- -->
...
![](250902_plot_analyze_spn4_datasets_files/figure-gfm/4cell_test-3.png)<!-- -->
