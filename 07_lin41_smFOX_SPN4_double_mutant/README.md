...
fill_colors <- c(
  "2-cell_DG5965_bright" = "lightblue", 
  "2-cell_DG5965_dark" = "lightblue", 
  "2-cell_wDMP91_bright" = "gray",
  "2-cell_wDMP91_dark" = "gray",
  "4-cell_DG5965_bright" = "lightblue", 
  "4-cell_DG5965_dark" = "lightblue",
  "4-cell_wDMP91_bright" = "gray",
  "4-cell_wDMP91_dark" = "gray"
)
...
p <- ggplot(df, aes(x = subdirectory, y = `lin_41_mRNA_molecules`, fill = subdirectory)) +
  ...
  scale_x_discrete(labels = c(
                              "2-cell_DG5965_dark" = "2-cell_DG5965_dark",
                              "4-cell_DG5965_dark" = "4-cell_DG5965_dark",
                              ...
                              "2-cell_wDMP91_dark", "2-cell_wDMP91_dark",
                              "4-cell_wDMP91_bright", "4-cell_wDMP91_bright",
                              "4-cell_wDMP91_dark", "4-cell_wDMP91_dark")) +
...
# Save to CSV
output_path_anova <- "../03_output/Fig6_lin41_smFOX_SPN4-double_anova_summary.csv"
...
# Save to CSV
output_path <- "../03_output/Fig6_lin41_smFOX_SPN4-double_tukey_posthoc_results.csv"
...
shapiro_path <- "../03_output/Fig6_lin41_smFOX_SPN4-double_shapiro_results.csv"
...
kruskal_path <- "../03_output/Fig6_lin41_smFOX_SPN4-double_kruskal_test_results.csv"
...
if (kruskal_test_results$p < 0.05) {
  ...
  dunn_path <- "../03_output/Fig6_lin41_smFOX_SPN4-double_dunn_posthoc_results.csv"
